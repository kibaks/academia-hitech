          ...
          <div className="w-full max-w-2xl rounded-3xl bg-white border border-slate-200 p-6 sm:p-8 space-y-6 shadow-2xl my-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {courses.map((course) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-2 rounded-lg text-left text-xs flex items-center gap-2 transition-all ${
                          isAssigned
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-xl text-xs font-bold bg-sky-500 hover:bg-sky-400 text-white shadow-xs shadow-sky-500/20 active:scale-95 transition-all flex items-center gap-2"
                >
                  <CheckCircle2 className="w-4 h-4" />
                  <span>{editingTrainer ? 'Enregistrer les Modifications' : 'Créer et Enregistrer'}</span>
                </button>
              </div>
            </form>
          </div>
