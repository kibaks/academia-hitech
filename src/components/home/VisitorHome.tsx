    ...
    <div id="visitor-homepage-root" className="space-y-20 pb-16">
      ...
      <section className="relative overflow-hidden pt-4 sm:pt-8 pb-12">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-6">
          {/* Tagline Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 border border-indigo-200/80 text-indigo-700 text-xs font-semibold shadow-xs animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <div className="pt-2 max-w-2xl mx-auto">
            <div className="p-2 rounded-2xl bg-white border border-slate-200 shadow-md flex flex-col sm:flex-row gap-2">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-xl text-sm font-semibold bg-indigo-600 hover:bg-indigo-700 text-white flex items-center justify-center gap-2 shadow-xs transition-all"
              >
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-4">
              <button
                ...
                className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-slate-900 hover:bg-slate-800 text-white shadow-xs transition-all flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl text-xs font-semibold bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 transition-all flex items-center gap-1.5"
              >
      ...
      {/* 2. ROLE ORIENTATION & ACCESS SYSTEM ("POUR QUI EST ACADEMIA ITECH ?") */}
      <section className="max-w-7xl mx-auto">
        <div className="text-center space-y-3 mb-10">
          <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Écosystème Rôles & Permissions</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-6">
            ...
            <button
              onClick={() => onOpenAuth('register', 'learner')}
              className="w-full py-2.5 rounded-xl text-xs font-bold bg-indigo-600 hover:bg-indigo-700 text-white transition-all shadow-xs"
            >
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-6">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white transition-all shadow-xs"
            >
      ...
      <section className="max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Formations Phares</span>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
              Découvrez nos programmes d'excellence certifiants
            </h2>
          </div>
          <button
            onClick={onExploreCatalog}
            ...
            >
              ...
              <div className="p-5 pt-0 border-t border-slate-100 mt-2 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-xl text-xs font-bold bg-indigo-50 hover:bg-indigo-600 hover:text-white text-indigo-700 border border-indigo-200 transition-all flex items-center gap-1.5"
                >
      ...
      {/* 4. VERIFY CERTIFICATE PUBLIC TOOL */}
      ...
      {/* 5. PARTNER CENTERS & CAMPUS NETWORK */}
      <section className="max-w-7xl mx-auto space-y-6">
        <div className="text-center space-y-2">
          <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Réseau Académique International</span>
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">
          ...
          {centers.map((center) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100 text-center">
                ...
                <div className="p-2 rounded-xl bg-slate-50">
                  <div className="text-xs font-bold text-indigo-600 uppercase font-bold">{center.subscriptionPlan}</div>
      ...
      <section className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-700 text-white p-8 sm:p-12 text-center space-y-6 shadow-xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
          <button
            onClick={() => onOpenAuth('register', 'learner')}
            className="px-6 py-3 rounded-xl text-sm font-bold bg-white text-indigo-900 hover:bg-slate-100 shadow-md transition-all"
          >
            Créer mon Compte Gratuitement
          </button>
          <button
            onClick={() => onOpenAuth('login')}
            className="px-6 py-3 rounded-xl text-sm font-bold bg-indigo-800/80 hover:bg-indigo-800 text-white border border-indigo-400/40 transition-all"
          >
